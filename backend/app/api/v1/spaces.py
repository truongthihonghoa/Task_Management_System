...
def list_spaces(
    ...
    return space_crud.list_spaces(db, include_deleted=include_deleted)
...
def list_owner_trash(owner_id: str, db: Session = Depends(get_db)):
    return space_crud.list_owner_trash(db, owner_id)
...
def list_space_members(space_id: str, db: Session = Depends(get_db)):
    return space_crud.list_space_members(db, space_id)
